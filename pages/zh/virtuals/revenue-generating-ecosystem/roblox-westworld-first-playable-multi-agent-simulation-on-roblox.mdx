...
<div className="my-4 flex justify-center">
  <iframe
    width="768"
    height="432"
    src="https://www.youtube.com/embed/TuiThofZKhk"
    title="Presenting Project Westworld: The First Playable Autonomous World on Roblox"
    frameborder="0"
...
![](/images/virtuals/the-simulation-built-in-roblox.webp) _在 Roblox 中构建的模拟游戏_
...
![](/images/virtuals/example-of-an-agent-character-profile.avif) _智能体角色资料示例_
...
![](/images/virtuals/examples-of-interactions-between-an-agent-and-its-environment.webp) _智能体与环境之间的互动示例_
...
<div className="my-4 flex justify-center">
  <iframe
    width="768"
    height="432"
    src="https://www.youtube.com/embed/FUTG_xkmKlQ"
    title="Diverse storylines in AI Westworld Roblox game"
    frameborder="0"
    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
    referrerpolicy="strict-origin-when-cross-origin"
    allowfullscreen
...
<div className="text-center text-gray-500">*无限种情景*</div>
