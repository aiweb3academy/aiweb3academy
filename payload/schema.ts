...
export const enum_members_roles = pgEnum('enum_members_roles', ['admin', 'member'])
...
export const members = pgTable(
  'members',
  {
    ...
    name: varchar('name'),
    roles: enum_members_roles('roles').notNull().default('member'),
  ...
  columns => ({
    ...
    members_created_at_idx: index('members_created_at_idx').on(columns.createdAt),
    members_email_idx: uniqueIndex('members_email_idx').on(columns.email),
    members_username_idx: uniqueIndex('members_username_idx').on(columns.username),
  }),
)
...
export const posts_rels = pgTable(
  ...
  columns => ({
    ...
    posts_rels_members_id_idx: index('posts_rels_members_id_idx').on(columns.membersID),
    parentFk: foreignKey({
      columns: [columns['parent']],
      foreignColumns: [posts.id],
...
export const _posts_v_rels = pgTable(
  ...
  columns => ({
    ...
    _posts_v_rels_members_id_idx: index('_posts_v_rels_members_id_idx').on(columns.membersID),
    parentFk: foreignKey({
      columns: [columns['parent']],
      foreignColumns: [_posts_v.id],
...
export const payload_locked_documents_rels = pgTable(
  ...
  columns => ({
    ...
    payload_locked_documents_rels_members_id_idx: index('payload_locked_documents_rels_members_id_idx').on(
      columns.membersID,
    ),
...
export const payload_preferences_rels = pgTable(
  ...
  columns => ({
    ...
    payload_preferences_rels_members_id_idx: index('payload_preferences_rels_members_id_idx').on(columns.membersID),
    parentFk: foreignKey({
      columns: [columns['parent']],
...
export const relations_members = relations(members, () => ({}))
...
export const relations__posts_v_rels = relations(_posts_v_rels, ({ one }) => ({
  ...
  membersID: one(members, {
    fields: [_posts_v_rels.membersID],
    references: [members.id],
    relationName: 'members',
  }),
}))
...
type DatabaseSchema = {
  enum_members_roles: typeof enum_members_roles
