...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_members_roles" AS ENUM('admin', 'member');
  ...
  CREATE TABLE IF NOT EXISTS "members" (
  	...
  	"name" varchar,
  	"roles" "enum_members_roles" DEFAULT 'member' NOT NULL,
  ...
  CREATE INDEX IF NOT EXISTS "posts_rels_members_id_idx" ON "posts_rels" USING btree ("members_id");
  ...
  CREATE INDEX IF NOT EXISTS "_posts_v_rels_members_id_idx" ON "_posts_v_rels" USING btree ("members_id");
